...
function App() {
  return (
    <div className="md:hidden max-w-screen max-h-screen flex flex-col items-center py-10">
      ...
      <div className="flex gap-3 items-center">
        <img className="w-[65px] h-[65px] rounded-full" src={src} alt="" />
        <div className="flex flex-col gap-2">
          <h1 className="text-white text-center text-2xl font-bold glow">
